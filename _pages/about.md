<img width="2301" height="591" alt="image" src="https://github.com/user-attachments/assets/af980498-0190-4595-bae1-b86f79484207" />
...
<ul>
	<li>
		<font color="#8bdaf7">Distinguishing the impact of river discharge and submarine groundwater discharge on phytoplankton community in coastal water</font> <br>
	...
	<li>
		<font color="#8bdaf7">The role of dissolved organic matter in fuelling coastal hypoxia: Identifying key molecules and drivers</font> <br>
	...
	<li>
		<font color="#8bdaf7">Enhancing tree-based machine learning for chlorophyll-a prediction in coastal seawater through spatiotemporal feature integration</font> <br>
	...
	<li>
		<font color="#8bdaf7">Breaking the Technical Barrier for High Spatial Resolution Monitoring: A Novel Approach to Multi-Level Groundwater Monitoring System Development</font> <br>
	...
	<li>
		<font color="#8bdaf7">Disentangling external loadings, hydrodynamics and biogeochemical controls on the fate of nitrate in a coastal embayment</font> <br>
	...
	<li>
		<font color="#8bdaf7">Unraveling the impact of Spartina alterniflora invasion on greenhouse gas production and emissions in coastal saltmarshes: New insights from dissolved organic matter characteristics and surface-porewater interactions</font> <br>
    ...
    <li>
		<font color="#8bdaf7">Spatiotemporal-aware machine learning approaches for dissolved oxygen prediction in coastal waters</font> <br>
	...
	<li>
		<font color="#8bdaf7">Seasonal changes of dissolved organic matter chemistry and its linkage with greenhouse gas emissions in saltmarsh surface water and porewater interactions</font> <br>
